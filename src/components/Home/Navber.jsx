      ...
      <Container className="g-0">
        <Navbar expand="lg" className="">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto gap-[32px] mr-[48px]   items-center list-main">
              ...
              <button className="text-white px-[48px] py-[16px] nav-btn border-1 rounded-[41px] hover:bg-[#FCD980] duration-300 ">Contact us</button>
            </NavLink>
            </Nav>
