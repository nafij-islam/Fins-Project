        ...
        <Row className="fromhmain g-0">
          <Col lg={6}>
            <div className="fromhoveranim">
              ...
              <div className="py-[96px] pl-[96px] bg-[#1c1e537e] fromhovertext">
                <H3Com className="font-poppins text-white text-[54px] pb-[24px] font-semibold w-[480px] leading-[75px]">
                  Building stellar websites for early startups
                </H3Com>
                <PtagCom className="font-poppins text-[16px] text-white font-medium w-[460px]">
          ...
          <Col className="z-10" lg={6}>
            <div className="bg-[#1C1E53] pt-[96px] pl-[96px] pr[96px]">
              ...
              <PtagCom className="text-white font-manrope text-[16px] pb-[20px] font-medium leading-[28px] w-[400px]">
